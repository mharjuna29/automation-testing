...
Create Event
    ...
    Input Text                                  (//input[@id='__BVID__111'])[1]                                     Testing Create Event With Robot Framework
    Input Text                                  ${desc}                                                             lorem ipsum
    Input Text                                  (//input[@id='__BVID__116'])[1]                                     Mr. Robot Framework
    ...
    Choose File                                 ${uploadFile}                                                       ${myDocs}
    Choose File                                 (//input[@accept='.jpg,.png,.jpeg'])[1]                             ${myFile}
    Sleep    2s
    Page Should Contain Button                  (//button[normalize-space()='Clear'])[1]
    ...
    Input Text                                  //*[@id="__BVID__158"]                                              Coba Membuat Acara Menggunakan Robot Framework
    Input Text                                  ${descID}                                                           Deskripsi testing automated testing by Robot Framework
